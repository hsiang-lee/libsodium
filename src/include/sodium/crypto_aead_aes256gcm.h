...
int crypto_aead_aes256gcm_encrypt_detached(unsigned char *c, unsigned char *mac, unsigned long long *maclen_p, const unsigned char *m,
                                           ...
                                           const unsigned char *npub, const unsigned char *k) __attribute__((nonnull(1, 2, 9, 10)));
...
int crypto_aead_aes256gcm_decrypt_detached(unsigned char *m, unsigned char *nsec, const unsigned char *c, unsigned long long clen,
                                           ...
                                           const unsigned char *k) __attribute__((warn_unused_result)) __attribute__((nonnull(3, 5, 8, 9)));

/* -- Precomputation interface -- */

int crypto_aead_aes256gcm_beforenm(crypto_aead_aes256gcm_state *ctx_, const unsigned char *k) __attribute__((nonnull));
...
void crypto_aead_aes256gcm_keygen(unsigned char k[crypto_aead_aes256gcm_KEYBYTES]) __attribute__((nonnull));
