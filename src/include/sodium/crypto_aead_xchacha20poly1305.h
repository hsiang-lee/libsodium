...
int crypto_aead_xchacha20poly1305_ietf_encrypt(unsigned char *c, unsigned long long *clen_p, const unsigned char *m, unsigned long long mlen,
                                               ...
                                               const unsigned char *npub, const unsigned char *k) __attribute__((nonnull(1, 8, 9)));
...
void crypto_aead_xchacha20poly1305_ietf_keygen(unsigned char k[crypto_aead_xchacha20poly1305_ietf_KEYBYTES]) __attribute__((nonnull));
