...
int crypto_shorthash(unsigned char *out, const unsigned char *in, unsigned long long inlen, const unsigned char *k) __attribute__((nonnull(1, 4)));

void crypto_shorthash_keygen(unsigned char k[crypto_shorthash_KEYBYTES]) __attribute__((nonnull));
