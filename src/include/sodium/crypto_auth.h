...
int crypto_auth(unsigned char *out, const unsigned char *in, unsigned long long inlen, const unsigned char *k) __attribute__((nonnull(1, 4)));
...
void crypto_auth_keygen(unsigned char k[crypto_auth_KEYBYTES]) __attribute__((nonnull));
