...
int crypto_sign_ed25519_keypair(unsigned char *pk, unsigned char *sk) __attribute__((nonnull));

int crypto_sign_ed25519_seed_keypair(unsigned char *pk, unsigned char *sk, const unsigned char *seed) __attribute__((nonnull));

int crypto_sign_ed25519_pk_to_curve25519(unsigned char *curve25519_pk, const unsigned char *ed25519_pk) __attribute__((warn_unused_result))
__attribute__((nonnull));

int crypto_sign_ed25519_sk_to_curve25519(unsigned char *curve25519_sk, const unsigned char *ed25519_sk) __attribute__((nonnull));

int crypto_sign_ed25519_sk_to_seed(unsigned char *seed, const unsigned char *sk) __attribute__((nonnull));

int crypto_sign_ed25519_sk_to_pk(unsigned char *pk, const unsigned char *sk) __attribute__((nonnull));

int crypto_sign_ed25519ph_init(crypto_sign_ed25519ph_state *state) __attribute__((nonnull));

int crypto_sign_ed25519ph_update(crypto_sign_ed25519ph_state *state, const unsigned char *m, unsigned long long mlen) __attribute__((nonnull(1)));
